...
public class AccountListResponseBody {
	...
	public AccountListResponseBody(QueryParameter queryParameter, QueryResult queryResult) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AccountListResponseBody other = (AccountListResponseBody) obj;
	...
	public String toString() {
		return "AccountListResponseBody [queryParameter=" + queryParameter + ", queryResult=" + queryResult + "]";
	}
