...
public class QueryParameter {
	...
	public QueryParameter(String qrAssetType, String qrSellBuyType, String qrAccNo, String qrOrderDate,
			String qrIsinCode, String qrOrderNo, int count, String page) {
		super();
	...
	public int hashCode() {
		...
		result = prime * result + ((qrOrderNo == null) ? 0 : qrOrderNo.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (qrOrderDate == null) {
			...
			return false;
		if (qrOrderNo == null) {
			if (other.qrOrderNo != null)
				return false;
		} else if (!qrOrderNo.equals(other.qrOrderNo))
			return false;
	...
	public String toString() {
		return "QueryParameter [qrAssetType=" + qrAssetType + ", qrSellBuyType=" + qrSellBuyType + ", qrAccNo="
				+ qrAccNo + ", qrOrderDate=" + qrOrderDate + ", qrIsinCode=" + qrIsinCode + ", qrOrderNo=" + qrOrderNo
