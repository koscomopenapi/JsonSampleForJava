...
public class OrderDetailListResponseBody {
	...
	public OrderDetailListResponseBody(QueryParameter queryParameter, QueryResult queryResult) {
		super();
	...
	public String toString() {
		return "OrderDetailListResponseBody [queryParameter=" + queryParameter + ", queryResult=" + queryResult + "]";
	}
