...
public class CommonHeaderForRequest {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CommonHeaderForRequest other = (CommonHeaderForRequest) obj;
		if (certDn == null) {
	...
	public String toString() {
		return "CommonHeaderForRequest [reqIdPlatform=" + reqIdPlatform + ", reqIdConsumer=" + reqIdConsumer
				+ ", certDn=" + certDn + ", ci=" + ci + "]";
	}
}
